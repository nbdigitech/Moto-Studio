  ...
  return (
    <>
      <div className="all-product-heading">
        <div style={{ paddingTop: "26px", paddingBottom: "40px" }}>
          ...
          <div className="products-header text-center">
            <h1 className="product-name-head-text">Terms Of Service</h1>
          </div>
        </div>
      </div>
      ...
      <div className="container py-5">
        ...
        Welcome to motostudio.in! These terms and conditions outline the rules
        and regulations for the use of MototSudio's Website, located at
        https://motostudio.in/. By accessing this website we assume you accept
        these terms and conditions. Do not continue to use motostudio.in if you
        ...
        referring to same.
        <h4 className="text-start">Cookies</h4>
        We employ the use of cookies. By accessing motostudio.in, you agreed to
        use cookies in agreement with the MototSudio's Privacy Policy. Most
        ...
        cookies.
        <h4 className="text-start">License</h4>
        Unless otherwise stated, MototSudio and/or its licensors own the
        intellectual property rights for all material on motostudio.in. All
        intellectual property rights are reserved. You may access this from
        motostudio.in for your own personal use subjected to restrictions set in
        these terms and conditions. You must not:
        <ul>
          <li>Republish material from motostudio.in</li>
          <li>Sell, rent or sub-license material from motostudio.in</li>
          <li>Reproduce, duplicate or copy material from motostudio.in</li>
          <li>Redistribute content from motostudio.in</li>
        </ul>
        ...
        MototSudio does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of MototSudio,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, MototSudio shall not be
        ...
        <br />
        MototSudio reserves the right to monitor all Comments and to remove any
        ...
        You hereby grant MototSudio a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
        <h4 className="text-start">Hyperlinking to our Content</h4>
        ...
        the hyperlink compensates the absence of MototSudio; and (d) the link is
        ...
        e-mail to MototSudio. Please include your name, your organization name,
        ...
        No use of MototSudio's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
        <br />
        <h4 className="text-start">iFrames</h4>
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website.
        <h4 className="text-start">Content Liability</h4>
        ...
        <br />
        <h4 className="text-start">Your Privacy</h4>
        Please read Privacy Policy
        <h4 className="text-start">Reservation of Rights</h4>
        ...
        <h4 className="text-start">Removal of links from our website</h4>
